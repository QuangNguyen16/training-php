		...
		<div class="row-fluid">
			<div class="span12">
				<div class="widget-box">
					<div class="widget-title"> <span class="icon"><a href="form_addprotype.php"><i class="icon-plus"></i></a></span>
						<h5>Products</h5>
					</div>
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped">
							...
							<tr class="">
								...
								<td><center><img src="public/images/<?php echo $value['type_img']?>" style="width:50px"></center></td>
								<td>
								<a href="form_editprotype.php?t=<?php echo $value['type_ID'] ?>" class="btn btn-success btn-mini">Edit</a>
								<a href="delete.php?t=<?php echo $value['type_ID'] ?>" class="btn btn-danger btn-mini">Delete</a>
								</td>
