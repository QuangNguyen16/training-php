...
<div id="content">
	<div id="content-header">
		...
		<?php
		$product=new Product;
		echo "Tổng: ".count($product->Searchkeyword2($_GET['key']))." sản phẩm";
		?>
		</h1>
	</div>
				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped">
							...
							<tbody>
								<?php 
								$getallproduct=$product->Searchkeyword2($_GET['key']);
							...
							<tr class="">
								...
								<td>
									<a href="fromedit.php?p=<?php echo $value['id'] ?>" class="btn btn-success btn-mini">Edit</a>
