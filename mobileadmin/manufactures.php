				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped">
							...
							<tbody>
								<?php
								$getManufacturess= $manufacturess->getAllManufactures();
								//var_dump($getManufacturess);
								foreach($getManufacturess as $value){
								?>
							<tr class="">
						
								<td> <?php echo $value['manu_ID']?></td>
								<td><?php echo $value['manu_name'] ?></td>
								<td><center><img src="public/images/<?php echo $value['manu_img']?>" style="width:30px"></center></td>
								<td>
								<a href="form_editmanu.php?id=<?php echo $value['manu_ID'] ?>" class="btn btn-success btn-mini">Edit</a>
								<a href="delete.php?id=<?php echo $value['manu_ID'] ?>" class="btn btn-danger btn-mini">Delete</a>
								</td>
