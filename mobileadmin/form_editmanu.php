				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped">
							...
							<tbody>
								<?php
								$getManufacturess= $manufacturess->GetManuByID($_GET['id']);
								//var_dump($getManufacturess);
								foreach($getManufacturess as $value){
								?>
							<tr class="">
                                <form action="update.php?id=<?php echo $value['manu_ID'] ?>" method="post" enctype="multipart/form-data">
								<td> <input type="text" name="manu_ID" value ="<?php echo $value['manu_ID']?>" style="text-align: center;"></td>
								<td><input type="text" name="manu_name" value="<?php echo $value['manu_name'] ?>"></td>
