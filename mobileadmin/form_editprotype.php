					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped">
							...
							<tbody>
								<?php
								$protype=new Protype;
								$getprotype= $protype->getProtypeByID($_GET['t']);
								//var_dump($getManufacturess);
								foreach($getprotype as $value){
								?>
							<tr class="">
                                <form action="update.php?t=<?php echo $_GET['t'] ?>" method="post" enctype="multipart/form-data">
								<td> <input type="text" name="type_ID" value ="<?php echo $value['type_ID']?>" style="text-align: center;"></td>
								<td><input type="text" name="type_name" value="<?php echo $value['type_name'] ?>"></td>
